...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-6 left-6 right-6 z-50 max-w-lg mx-auto">
      <div className="flex justify-around items-center h-20 bg-white/80 backdrop-blur-2xl border border-white/50 shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-[2.5rem] px-4">
        {navItems.map((item) => {
